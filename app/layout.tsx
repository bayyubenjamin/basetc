...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${APP_URL}/img/feed.png`, width: 1200, height: 630, alt: "BaseTC Console" }],
  },
  twitter: {
  ...
  return (
    <html lang="en">
      <body className="min-h-dvh antialiased pt-[calc(env(safe-area-inset-top)+36px)]">
        ...
        <footer className="fixed bottom-1 right-1 text-[10px] text-gray-500 opacity-50">v1.2-base-sprint</footer>
      </body>
    </html>
  );
}
