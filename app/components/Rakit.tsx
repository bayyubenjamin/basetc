...
const Rakit: FC = () => {
  ...
  const unlockSlot = () => setMessage("Slot unlocked! You can now equip an extra GPU.");
  ...
  return (
    <div className="space-y-4 px-4 pt-4 pb-8">
      ...
      <div className="grid grid-cols-3 gap-2 text-center text-xs md:text-sm">
        <div className="bg-neutral-800 rounded-lg p-2"><div className="text-neutral-400">Basic</div><div className="text-lg font-semibold">x{String(basicCount)}</div></div>
        <div className="bg-neutral-800 rounded-lg p-2"><div className="text-neutral-400">Pro</div><div className="text-lg font-semibold">x{String(proCount)}</div></div>
        <div className="bg-neutral-800 rounded-lg p-2"><div className="text-neutral-400">Legend</div><div className="text-lg font-semibold">x{String(legendCount)}</div></div>
      </div>
      ...
      <div className="space-y-2">
        <button
          ...
          className={`w-full px-3 py-2 text-xs rounded-md ${
            !address || basicCount < needBP || merging ? "bg-neutral-700 text-neutral-500" : "bg-neutral-700 hover:bg-neutral-600 text-white"
          }`}
        ...
        <button
          ...
          className={`w-full px-3 py-2 text-xs rounded-md ${
            !address || proCount < needPL || merging ? "bg-neutral-700 text-neutral-500" : "bg-neutral-700 hover:bg-neutral-600 text-white"
          }`}
          title={!address ? "Connect wallet first" : undefined}
        >
        ...
        <button onClick={unlockSlot} className="w-full px-3 py-2 text-xs rounded-md bg-neutral-700 hover:bg-neutral-600 text-white">
          Unlock Slot
        </button>
      </div>
