...
export default function Monitoring() {
  // State dan logic untuk data dinamis bisa ditambahkan di sini
  return (
    <>
      <section className="panel flex flex-col gap-2.5">
        ...
        <div className="bg-[#01060a] rounded-lg border border-[#0f2130] p-2 font-mono text-xs text-[#9fd7ff] h-36 overflow-auto shadow-inner no-scrollbar">
          {/* Konten terminal */}
        </div>
      </section>
      ...
      <section className="panel">
        ...
        <div className="rounded-lg overflow-hidden border border-[#223146] bg-[#06101a] mt-2">
            <img src="/img/pro.png" alt="Mining Rigs" className="w-full h-auto" />
        </div>
